...
| Mean recorded timestep interval | ~0.35–0.40 s |
...
|--------|-------|
| Episodes | 100 |
| Simulator timestep | 50 ms (20 Hz nominal) |
| Effective dataset sampling rate | 2.77 ± 0.07 Hz |
| Mean timestep interval | 0.362 ± 0.051 s |
| Mean episode length | 100.1 ± 2.5 timesteps |
| Min / max episode length | 90 / 105 timesteps |
| Total timesteps | 10,014 |
| Mean episode duration | 35.85 ± 0.15 s |
| Total recording time | 3585.1 s (59.8 min) |
| Mean frozen-frame % | 8.83% |
| Cube x coverage | [0.474, 1.092] m |
| Cube y coverage | [-1.102, -0.762] m |
| Mean action step size | 34.7 mrad / step |
| Gripper transitions / episode | 2.0 (open → close → open) |
| All episodes complete | Yes |

### Joint Range of Motion

| Joint | Min (°) | Max (°) | Range (°) |
|-------|---------|---------|-----------|
| Joint 0 | -175.5 | -36.7 | 138.9 |
| Joint 1 | -36.6 | +59.5 | 96.1 |
| Joint 2 | +36.7 | +126.2 | 89.5 |
| Joint 3 | +85.5 | +237.6 | 152.1 |
| Joint 4 | +5.2 | +96.6 | 91.4 |
| Joint 5 | -78.9 | +117.9 | 196.8 |
...
- [x] Generate trajectory summary plots
- [x] Generate dataset overview statistics  
- [x] Visualise cube trajectories in 3D
- [x] Confirm coordinate frame (world vs robot base) for positions and EE pose
- [x] Confirm quaternion convention (`x,y,z,w` vs `w,x,y,z`)
- [ ] Add movement-threshold filter to recorder to drop frozen terminal frames
- [ ] Behaviour Cloning baseline training
- [ ] ACT policy training
- [ ] Evaluation & success rate comparison
